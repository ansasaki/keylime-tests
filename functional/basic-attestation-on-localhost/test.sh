...
rlJournalStart
    ...
    rlPhaseStartSetup "Do the keylime setup"
        ...
        # New verifier config
        rlRun "limeUpdateConf revocations enabled_revocation_notifiers [\"${REVOCATION_NOTIFIER}\", \"webhook\"]"
        ...
        if [ -n "$KEYLIME_TEST_DISABLE_REVOCATION" ]; then
            ...
            # New verifier config
            rlRun "limeUpdateConf revocations enabled_revocation_notifiers '[]'"
        fi
        # tenant
